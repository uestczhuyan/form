...
public class SettingShares {
	...
	public static final String ROOT = Environment.getExternalStorageDirectory()
			.getAbsolutePath() + "/form/formmap3V";
	...
	public static boolean storeCheck(boolean check1,boolean check2,boolean check3,SharedPreferences sharedPreferences){
		SharedPreferences.Editor editor = sharedPreferences.edit();
		try {
			editor.putBoolean(KEY_CHECK1, check1)
					.putBoolean(KEY_CHECK2, check2)
					.putBoolean(KEY_CHECK3, check3);
			return editor.commit();
		} catch (Exception e) {
			// TODO: handle exception
		}
	...
	public static boolean[] getCheck(SharedPreferences sharedPreferences) {
		boolean[] checks =  new boolean[3];
		checks[0] = sharedPreferences.getBoolean(KEY_CHECK1, true);
		checks[1] = sharedPreferences.getBoolean(KEY_CHECK2, true);
		checks[2] = sharedPreferences.getBoolean(KEY_CHECK3, true);
		return checks;
	}
